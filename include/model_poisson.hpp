  ...
  namespace models 
  {
    ...
    class poisson 
    {
      ...
      public:
        ...
        std::vector< int > ib_list;                           /**< If ib_list[i] == 1, then cell i is an immersed boundary cell. */
        std::vector< array_coo > coo_array;                   /**< Linear system associated with discretization of the Poisson equation. */
