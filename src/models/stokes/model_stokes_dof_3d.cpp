...
void
hgf::models::stokes::build_degrees_of_freedom_3d(const parameters& par, const hgf::mesh::voxel& msh)
{
...
void
hgf::models::stokes::dof_neighbors_3d(const parameters& par, const hgf::mesh::voxel& msh)
{
#pragma omp parallel
  {
